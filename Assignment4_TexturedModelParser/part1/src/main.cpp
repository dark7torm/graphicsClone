...
bool drawWireFrame = false; // If wire fram should be shown drawWireFrame = true
...
void VertexSpecification(OBJ obj){
	...
	gTexture.LoadTexture(obj.getPPM());
	...
	const std::vector<GLfloat> vertexData = obj.getPositions();
	// {
    // // 0 - Vertex
